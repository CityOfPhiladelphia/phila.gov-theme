...
function phila_gov_scripts() {
    ...
    wp_enqueue_style( 'pattern_portfolio', '//cityofphiladelphia.github.io/patterns/dist/0.10.0/css/patterns.css' );
    ...
    wp_enqueue_script( 'pattern-scripts', '//cityofphiladelphia.github.io/patterns/dist/0.10.0/js/patterns.min.js', array('jquery', 'foundation-js'), true );
