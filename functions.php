...
function phila_gov_scripts() {
  ...
  wp_enqueue_style( 'pattern_portfolio', '//cityofphiladelphia.github.io/patterns/dist/0.11.2/css/patterns.css' );
  ...
  wp_enqueue_script( 'pattern-scripts', '//cityofphiladelphia.github.io/patterns/dist/0.11.2/js/patterns.min.js', array('jquery', 'foundation-js'), true );
  ...
  wp_enqueue_script( 'swiftype', ( get_stylesheet_directory_uri() . '/js/jquery.swiftype.search.js' ), array('jquery', 'jquery-hashchange'), null, true );

  wp_enqueue_script( 'search', ( get_stylesheet_directory_uri() . '/js/dev/search.js' ), array('swiftype'), null, true );
}
